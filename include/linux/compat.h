...
#ifdef CONFIG_COMPAT
/* If this is enabled, must dela with definitions of COMPAT_SYSCALL_DEFINEx further down.
   See comments in ~/include/linux/syscalls.h regarding implemetation of SYSCALL_DEFINEx
   and aliasing.
*/
#error Review definition of COMPAT_SYSCALL_DEFINEx in this file.
