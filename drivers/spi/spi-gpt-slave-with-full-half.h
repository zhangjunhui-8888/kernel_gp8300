...
#define SPI_IOC_WR_TX_BUF_SIZE      _IOW(SPI_IOC_MAGIC, 4, __u32)
...
#define SPI_IOC_WR_FULL_DUPLEX      _IOW(SPI_IOC_MAGIC, 8, __u8)
#define SPI_IOC_WR_HALF_DUPLEX      _IOW(SPI_IOC_MAGIC, 9, __u8)
#define SPI_IOC_WR_WILL_RX_LEN      _IOW(SPI_IOC_MAGIC, 10, __u32)
