			      ...
			      int mclk)
{
	...
	case 44100:
	case 88200:
		if (data->soc == GPT_ASOC_UTILS_SOC_GPT20)
			new_baseclock = 56448000;
		else if (data->soc == GPT_ASOC_UTILS_SOC_GPT30)
...
//	int ret;
	...
	if (of_machine_is_compatible("nvidia,tegra20"))
		data->soc = GPT_ASOC_UTILS_SOC_GPT20;
	else if (of_machine_is_compatible("nvidia,tegra30"))
		data->soc = GPT_ASOC_UTILS_SOC_GPT30;
	else if (of_machine_is_compatible("nvidia,tegra114"))
		data->soc = GPT_ASOC_UTILS_SOC_GPT114;
	else if (of_machine_is_compatible("nvidia,tegra124"))
		data->soc = GPT_ASOC_UTILS_SOC_GPT124;
	else {
		data->soc = GPT_ASOC_UTILS_SOC_GPT20;
...
/*
	...
	ret = gpt_asoc_utils_set_rate(data, 44100, 256 * 44100);
	if (ret)
		goto err_put_cdev1;
...
EXPORT_SYMBOL_GPL(gpt_asoc_utils_fini);
